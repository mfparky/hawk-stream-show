    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border bg-card">
        <div className="mx-auto flex max-w-6xl items-center gap-3 px-4 py-3">
          <img src="/favicon.ico" alt="Newmarket Hawks" className="h-8 w-8 shrink-0 brightness-0 invert" style={{ display: 'none' }} onLoad={(e) => { e.currentTarget.style.removeProperty('display'); }} onError={(e) => { e.currentTarget.style.display = 'none'; }} />
          <div>
