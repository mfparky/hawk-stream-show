...
const KEYS = [CHANNEL_ID_KEY, YOUTUBE_API_KEY_KEY, YOUTUBE_PLAYLIST_ID_KEY, VENUE_NAME_KEY, VENUE_ADDRESS_KEY, VENUE_LAT_KEY, VENUE_LON_KEY];
    ...
    supabase
      ...
      .then(({ data }) => {
        ...
        setState({
          ...
          youtubePlaylistId: map[YOUTUBE_PLAYLIST_ID_KEY] || null,
